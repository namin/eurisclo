# Diff History for Eurisclo

The diffs of interests are:
...
- [LLM heurisics](https://github.com/namin/eurisclo/compare/namin:eurisclo:batch...namin:eurisclo:llm?expand=1)
